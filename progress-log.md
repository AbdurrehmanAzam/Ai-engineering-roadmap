...
- **Current Focus:** `Phase 01` – Python Fundamentals (CampusX – string functions completed, moving to Lists & Tuples on Day 24)  
- **Next Up:** `Phase 01` – Lists, Tuples, Sets, Dictionary (Days 24‑27), then Functions, then OOP (Phase 1.2)
